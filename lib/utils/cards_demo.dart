...
import 'package:flutter_bss_api/models/profiles.dart';
import 'package:flutter_bss_api/models/user.dart';
import 'package:fluttery_dart2/layout.dart';
import './matches.dart';

class CardStackDM extends StatefulWidget {
  final MatchEngine matchEngine;

  CardStackDM({this.matchEngine});

  @override
  _CardStackDMState createState() => _CardStackDMState();
}

class _CardStackDMState extends State<CardStackDM> {
  Key _frontCard;
  Match _currentMatch;
  ...
  void initState() {
    ...
    _frontCard = new Key(_currentMatch.user.name.first);
  }

  @override
  void didUpdateWidget(CardStackDM oldWidget) {
