...
class _CardStackState extends State<CardStack> {
  ...
  Widget _buildBackCard() {
    return Transform(
      ...
      child: ProfileCard(
        result: widget.matchEngine.nextMatch.user,
      ),
    );
  }
  ...
  Widget _buildFrontCard() {
    return ProfileCard(
      key: _frontCard,
      result: widget.matchEngine.currentMatch.user,
    );
  }
...
class _DraggableCardState extends State<DraggableCard> with TickerProviderStateMixin {
  ...
  void _onPanEnd(DragEndDetails details) {
    ...
    /// check left - right to save user into database
    setState(() {
...
class ProfileCard extends StatefulWidget {
  ...
  ProfileCard({Key key, this.result}) : super(key: key);
              ...
              children: <Widget>[
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                fit: BoxFit.cover,
                                image: NetworkImage(widget.result.picture.large)
                            )
                        ),
                      ),
                    ),
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      checkFirst(first, widget.result),
                            ...
                            children: <Widget>[
                              ...
                              IconButton(
                                ...
                                onPressed:() {
                                  setState(() {
                                    label = 'My name is';
                                    _content = '${widget.result.name.title}.${widget.result.name.first} ${widget.result.name.last}';
                                    first = false;
                                    checkFirst(first, widget.result);
                                  });
                                },
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  setState(() {
                                    ...
                                    _content = '${widget.result.location.street.number} ${widget.result.location.street.name},${widget.result.location.city},${widget.result.location.state}';
                                  });
                                },
                              ),
                            ],
                              ...
                              IconButton(
                                ...
                                onPressed: (){
                                  setState(() {
                                    ...
                                    _content = '${widget.result.login.password}';
                                  });
                                },
                              ),
                            ],
